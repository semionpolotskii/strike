    ...
    <div className="wrapper">
      <div className="card">
        ...
        <div className="card-body">
          ...
          <a
            href="https://www.pravo.by/pravovaya-informatsiya/normativnye-dokumenty/konstitutsiya-respubliki-belarus/"
            target="_blank"
          >
            конституции Беларуси
          </a>{" "}
          (статья 41) – которая является высшим законом, выше всех декретов и
          указов. Увольнения за забастовку незаконны. Каждое увольнение должно
          лишь подпитывать забастовку
        </div>
      </div>
      ...
      <div className="card">
        ...
        <div className="card-body">
          ...
          <strong>
            {" "}
            материально поможет каждому уволенному за забастовку{" "}
          </strong>
          – суммами до 1500 евро. Это «касса взаимопомощи», она распределяется
          через стачкомы предприятий. Организуйтесь в стачкомы с
          единомышленниками,{" "}
          <a href="https://bit.ly/2E4UOsp" target="_blank">связывайтесь</a>
          {" "}с Фондом Солидарности
        </div>
      </div>
      <div className="card">
        <div className="card-title">
