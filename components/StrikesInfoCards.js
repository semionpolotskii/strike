      ...
      <div className="col">
        <div className="card">
          <div className="card-title">
            Мне говорят, что забастовки незаконны
          </div>
        ...
        <div className="card">
          ...
          <div className="card-body">
            ...
            <strong>МАТЕРИАЛЬНО ПОМОЖЕТ КАЖДОМУ УВОЛЕННОМУ</strong> за
            забастовку – суммами до 1500 евро. На данный момент фонд собрал
            более 2,5 миллиона евро. Это «касса взаимопомощи», она
            распределяется через стачкомы предприятий. Организуйтесь в стачкомы
            с единомышленниками, связывайтесь с Фондом Солидарности
          </div>
        </div>
      </div>
      <div className="col">
        ...
        <div className="card">
          ...
          <div className="card-body">
            Всем с государственной формой собственности, включая самые
            небольшие, а также коммунальные и транспортные. Частным и ИП стоит
            просто отложить уплату налогов (санкции за такое мизерные).
          </div>
        </div>
      </div>
    </div>
