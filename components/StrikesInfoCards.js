    ...
    <div className="wrapper">
      ...
      <div className="card">
        ...
        <div className="card-body">
          ...
          <strong>МАТЕРИАЛЬНО ПОМОЖЕТ КАЖДОМУ УВОЛЕННОМУ</strong> за забастовку
          – суммами до 1500 евро. На данный момент фонд собрал более 2,5
          миллиона евро. Это «касса взаимопомощи», она распределяется через
